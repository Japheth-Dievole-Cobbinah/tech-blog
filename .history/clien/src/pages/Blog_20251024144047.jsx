...
const Blog = () => {
  ...
  const handleShare = (platform) => {
    ...
    const postTitle = encodeURIComponent(data?.title || "Check out this post!");
    let shareUrl = "";
    ...
    switch (platform) {
      ...
      case "twitter":
        ...
        break;
      case "googleplus":
        shareUrl = `https://plus.google.com/share?url=${postUrl}`;
        break;
      case "whatsapp":
  ...
  return data ? (
    <div className="relative">
      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        ...
        {/* 🟢 Share Buttons with Animated Tooltips */}
        <div className="my-24 max-w-3xl mx-auto text-center">
          <p className="font-semibold my-4 text-gray-800">Share this post:</p>
          <div className="flex justify-center gap-6 mt-3">
            {[
              { name: "facebook", icon: assets.facebook_icon, label: "Share on Facebook" },
              { name: "twitter", icon: assets.twitter_icon, label: "Share on Twitter" },
              { name: "googleplus", icon: assets.googleplus_icon, label: "Share on Google Plus" },
              { name: "whatsapp", icon: assets.whatsapp_icon, label: "Share on WhatsApp" },
            ].map((platform) => (
