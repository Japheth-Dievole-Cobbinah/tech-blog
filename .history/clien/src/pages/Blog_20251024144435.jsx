...
const Blog = () => {
  ...
  // ✅ Improved Share Function (with embedded post metadata)
  const handleShare = (platform) => {
    ...
    switch (platform) {
      case "facebook":
        shareUrl = `https://www.facebook.com/sharer/sharer.php?u=${postUrl}&quote=${postTitle}%20-%20${postDescription}`;
        break;
      case "twitter":
        shareUrl = `https://twitter.com/intent/tweet?url=${postUrl}&text=${postTitle}%20-%20${postDescription}`;
        break;
      case "linkedin":
  ...
  return data ? (
    <div className="relative">
      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        ...
        {/* 🟢 Share Buttons with Embedded Post Links */}
        <div className="my-24 max-w-3xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6 mt-3">
            {[
              ...
              { name: "linkedin", icon: assets.linkedin_icon, label: "LinkedIn" },
              { name: "whatsapp", icon: assets.whatsapp_icon, label: "WhatsApp" },
            ].map((platform) => (
