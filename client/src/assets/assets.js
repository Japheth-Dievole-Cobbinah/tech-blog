...
export const blogCategories = ['All', 'Technology', 'Cybersecurity', 'Lifestyle', 'Culture']
...
export const footer_data = [
      {
          title: "Quick Links",
          links: ["Home", "Cyber Security", "Contact Us", "FAQs"]
      },
      {
          title: "Need Help?",
          links: ["Cyber Security Tips", "Ai Tips", "Contact Us"]
      },
      {
          title: "Follow Us",
